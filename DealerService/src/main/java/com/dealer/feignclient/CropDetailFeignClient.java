...
public interface CropDetailFeignClient {
	...
	public ResponseEntity<CropDetails> addCropDetails(@RequestBody CropDetails cropDetails,@RequestHeader("Authorization") String token) throws CropNotFoundException;
